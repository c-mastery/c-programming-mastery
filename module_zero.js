        ...
        },
        {
            ...
            sections: [
                ...
                },
                {
                    ...
                    code: `// Now look at this code, and press the \"Edit and Run\" button, then edit the code to any decimal, binary and hexadecimal number your guts want. Don't worry if the code breaks, nothing teaches you faster than hands-on experience, especially errors!\n// In C, you can write binary, decimal, and hexadecimal literals:\nint decimal = 247;      // Base-10\nint hex = 0xF7;         // Hexadecimal (base 16)\nint binary = 0b11110111; // Binary (base 2)\n\nprintf("They are all exactly the same: %d, %d, %d\\n", decimal, hex, binary);\n// Output: They are all exactly the same: 247, 247, 247` //
                }
            ]
        },
        {
